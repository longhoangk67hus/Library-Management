...
namespace BaseCoreService.DL
{
    public interface IBaseDL
    {
        ...
        Task<T> ExecuteScalarAsyncUsingCommandText<T>(string commandText, IDictionary<string, object>? parameters = null, IDbConnection? connection = null, IDbTransaction? transaction = null);
